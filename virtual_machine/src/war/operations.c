...
/*   Updated: 2019/11/29 21:59:11 by hfrankly         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				op_ldi(t_corewar *vm, t_carriage *carriage, int8_t *arg_code)
{
	...
	if (arg3 == 0 && carriage->registers[arg3] == 852624)
		ft_putstr("");
}
...
void				op_add(t_corewar *vm, t_carriage *carriage, int8_t *arg_code)
{
	...
	if (res_reg == 0 && carriage->registers[res_reg] == 852624)
		ft_putstr("");
...
void				op_and(t_corewar *vm, t_carriage *carriage, int8_t *arg_code)
{
	...
	if (reg == 0 && carriage->registers[reg] == 852624)
		ft_putstr("");
